...
/**
 * @function resetOnMouseLeave
 * @description Resets highlights when mouse leaves a taxon
 * @param {string} taxonName - Name of the taxon to unhighlight
 */
function resetOnMouseLeave(taxonName) {
    if (typeof d3 === 'undefined') {
        return;
    }
